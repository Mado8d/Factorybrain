...
class TechnicianSkill(Base):
    ...
    __table_args__ = (
        UniqueConstraint("user_id", "skill_type", name="uq_tech_skill"),
    )
...
class MachineSkillRequirement(Base):
    ...
    __table_args__ = (
        UniqueConstraint("machine_id", "skill_type", name="uq_machine_skill"),
    )
...
class TechnicianAvailability(Base):
    ...
    __table_args__ = (
        UniqueConstraint("user_id", "date", "shift_type", name="uq_tech_avail"),
    )

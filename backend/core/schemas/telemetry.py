...
DEFAULT_WIDGET_LAYOUT: list[dict] = [
    {"id": "kpi-machines", "type": "kpi", "title": "Machines actief", "metric": "active_machines", "position": 0, "col_span": 1},
    ...
    {"id": "kpi-energy", "type": "kpi", "title": "Energieverbruik", "metric": "total_power_kw", "position": 3, "col_span": 1},
    {"id": "chart-vibration", "type": "line_chart", "title": "Vibratie trend", "node_type": "vibesense", "time_range_hours": 6, "chart_type": "line", "data_keys": [{"key": "vib_rms_x", "name": "RMS X", "color": "#3b82f6"}, {"key": "vib_rms_y", "name": "RMS Y", "color": "#10b981"}, {"key": "vib_rms_z", "name": "RMS Z", "color": "#f59e0b"}], "position": 4, "col_span": 1, "height": 250},
    {"id": "chart-anomaly", "type": "area_chart", "title": "Anomalie score", "node_type": "vibesense", "time_range_hours": 6, "chart_type": "area", "data_keys": [{"key": "anomaly_score", "name": "Anomalie", "color": "#8b5cf6"}], "thresholds": [{"value": 0.5, "color": "#ef4444", "label": "Drempel"}], "position": 5, "col_span": 1, "height": 250},
    ...
    {"id": "chart-energy-channels", "type": "area_chart", "title": "Verbruik per kanaal", "node_type": "energysense", "time_range_hours": 6, "chart_type": "area", "data_keys": [{"key": "channel_1_w", "name": "Kanaal 1", "color": "#3b82f6"}, {"key": "channel_2_w", "name": "Kanaal 2", "color": "#f59e0b"}, {"key": "channel_3_w", "name": "Kanaal 3", "color": "#10b981"}, {"key": "channel_4_w", "name": "Kanaal 4", "color": "#8b5cf6"}], "position": 7, "col_span": 1, "height": 250},
]
